...
In this OpenFeather model, this mechanism is divided into two separate parts:
...
Openfeather is available in a large version, which is based on the shape of a feather, and a small version, which is shaped like a section of a feather. 
First, you will have to 3D-print the two parts of the size you have chosen. For printing, we use a Voron V0.1 equipped with a 0.25mm Nozzle and use Flexfill TPU 98A as filament:
<a href="url"><img src="Pictures/Print_Hook.gif" width="100%"></a>
Then, using a lighter, remove the stringing and glue the two parts together. As glue, we use "53339 Tamiya - CA Cement for Rubber Tires", which is suitable for TPU. 
